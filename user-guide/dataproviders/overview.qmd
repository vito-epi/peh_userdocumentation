...
Input data are expected to:

- Follow the provided template format
- Adhere to the codebook

Deviation from the specification is reported during data validation, but not automatically corrected by the PEH Data Platform.
